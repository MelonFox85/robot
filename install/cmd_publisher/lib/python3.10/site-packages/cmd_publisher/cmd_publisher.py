...
class CmdPublisher(Node):
    ...
    def timer_callback(self):
        ...
        msg.data = [
            self.integral_1,  # Первая переменная: интеграл от единицы
            0.0,              # Вторая переменная: ноль
            self.integral_3,  # Третья переменная: интеграл от единицы
            1.0,              # Четвертая переменная: единица
            0.0,              # Пятая переменная: ноль
            1.0               # Шестая переменная: единица
        ]
